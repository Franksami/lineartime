  ...
  switch (action.type) {
    ...
    case 'UPDATE_SUGGESTION':
      return {
        ...
        pendingSuggestions:
          action.payload.updates.action === 'accept'
...
export function AIProvider({ children }: AIProviderProps) {
  ...
  const generateInsights = useCallback((_events: Event[]) => {
...
export function useAISuggestions() {
  const { state, addSuggestion, acceptSuggestion, dismissSuggestion, clearSuggestions } =
    useAIContext();
  return {
...
export function useAIAssistant() {
  const { state, startAssistantConversation, sendAssistantMessage, endAssistantConversation } =
    useAIContext();
  return {
