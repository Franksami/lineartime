...
export class SummarizerAgent {
  ...
  async processMessage(
    ...
    try {
      ...
      const { intent, confidence, entities } = await this.classifyIntent(userMessage, workspaceContext)
      ...
      const knowledgeContext = await this.queryRelevantContext(intent, updatedSlots, workspaceContext)
  ...
  private async generateContextualResponse(
    ...
    const contextPrompt = this.buildContextPrompt(intent, slots, knowledgeContext, workspaceContext)
