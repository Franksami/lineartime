...
test.describe('UI Positioning Fixes Validation', () => {
  test('Visual validation of positioning fixes', async ({ page }) => {
    ...
    await page.waitForSelector('text=LinearTime', { timeout: 10000 })
    ...
    const linearTimeHeader = page.locator('text=LinearTime').first()
    ...
    console.log('Screenshots saved: ui-fixes-validation-desktop.png and ui-fixes-validation-mobile.png')
  })
