...
test.describe('Playground Components - Comprehensive Testing', () => {
  ...
  test.describe('Onboarding Flow Testing', () => {
    ...
    test('should handle step progression', async ({ page }) => {
      ...
      const nextButton = page.locator(
        '[data-testid="onboarding-next"], button:has-text("Next"), button:has-text("Continue")'
      );
  ...
  test.describe('Mobile Responsiveness', () => {
    ...
    test('should show mobile-optimized navigation', async ({ page }) => {
      ...
      const mobileNav = page.locator(
        '[data-testid="mobile-nav"], .mobile-menu, [aria-label*="menu"]'
      );
  ...
  test.describe('Performance and Error Handling', () => {
    test('should handle navigation errors gracefully', async ({ page }) => {
      ...
      const isRedirected =
        page.url().includes('/playground') && !page.url().includes('invalid-route');
