...
test.describe('FullCalendar Pro Foundation Validation', () => {
  ...
  test('Should maintain LOCKED horizontal foundation structure in linearYear view', async ({ page }) => {
    // Ensure we're in linearYear view
    await page.click('button:has-text("Linear Year")')
    await page.waitForTimeout(2000)
    
    // Switch to LinearCalendar Pro view and validate the foundation
