...
test.describe('🤖 AI Scheduling Engine Feature Testing', () => {
  ...
  test('should provide smart time slot recommendations', async ({ page }) => {
    ...
    const createEventTrigger = page
      .locator('button:has-text("Create"), [data-testid="create-event"], .add-event')
      .first();
  ...
  test('visual regression - AI scheduling interface', async ({ page }) => {
    ...
    const aiTrigger = page
      .locator('button:has-text("AI"), [data-testid="ai-assistant"], .ai-panel')
      .first();
