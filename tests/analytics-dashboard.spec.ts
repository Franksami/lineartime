...
test.describe('📊 Analytics Dashboard Feature Testing', () => {
  ...
  test('should display event category breakdown', async ({ page }) => {
    ...
    await expect(page.locator('text=/personal|work|effort|note/').first()).toBeVisible({ timeout: 10000 })
  })
  ...
  test('should show monthly activity tracking', async ({ page }) => {
    ...
    await expect(page.locator('text=/Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec/').first()).toBeVisible({ timeout: 10000 })
  })
  ...
  test('should display charts and visualizations', async ({ page }) => {
    ...
    await expect(page.locator('text=Chart visualization coming soon')).toBeVisible({ timeout: 10000 })
