...
export function MobileCalendarView({
  ...
  const { bind, containerRef, gestureState, zoom, animatedStyle, isPulling } = useCalendarGestures({
  ...
  return (
    <div
      ...
      className={cn('relative h-full overflow-hidden bg-background touch-pan-y', className)}
      {...bind()}
    >
      ...
      <div className="sticky top-0 z-10 bg-background border-b border-border">
        <div className="flex items-center justify-between p-4">
          ...
          <h2 className="text-lg font-semibold">{format(viewDate, 'MMMM yyyy')}</h2>
      ...
      {/* Calendar Grid */}
      <animated.div style={animatedStyle} className="p-2">
