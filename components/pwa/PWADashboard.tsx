              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                    ...
                    <Badge
                      variant={getCapabilityStatus(capabilities.fileHandlingSupported).variant}
                    >
                  ...
                  <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                    ...
                    <Badge
                      variant={getCapabilityStatus(capabilities.periodicSyncSupported).variant}
                    >
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-medium">{Math.round(metrics.timeOnSite / 60000)}m</span>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-medium">
                        {formatTimeAgo(metrics.lastInstallPrompt)}
                      </span>
                    </div>
                  </div>
                  ...
                  {metrics.installPromptShown > 0 && (
                    <div className="pt-2">
                      ...
                      <div className="text-xs text-muted-foreground mt-1">
                        {Math.round(
                          (metrics.installPromptAccepted / metrics.installPromptShown) * 100
                        )}
                        %
                      </div>
                    </div>
          ...
          <TabsContent value="controls" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Test and control PWA features</CardDescription>
              </CardHeader>
