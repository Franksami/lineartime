...
const EnhancedCalendarToolbar: React.FC<EnhancedCalendarToolbarProps> = ({
  ...
  const getSyncIcon = () => {
    switch (syncStatus) {
      case 'success':
        return <Wifi className="h-4 w-4 text-green-500 /* TODO: Use semantic token */ /* TODO: Use semantic token */" />;
      case 'error':
        return <WifiOff className="h-4 w-4 text-red-500 /* TODO: Use semantic token */ /* TODO: Use semantic token */" />;
      case 'syncing':
        ...
        <AnimatePresence>
          {syncStatus === 'syncing' && showSyncStatus && (
            <motion.div
              ...
              className="bg-primary/10 border-t border-blue-500 /* TODO: Use semantic token */ /* TODO: Use semantic token *//20 px-4 py-2"
            >
              <div className="flex items-center gap-2 text-sm text-blue-600 /* TODO: Use semantic token */ /* TODO: Use semantic token */ dark:text-blue-400 /* TODO: Use semantic token */ /* TODO: Use semantic token */">
