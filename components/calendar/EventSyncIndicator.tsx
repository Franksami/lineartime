...
import { AlertCircle, Calendar, CheckCircle, Cloud, CloudOff, RefreshCw } from 'lucide-react';
...
export function EventSyncIndicator({
  ...
  const content = (
    <div className={cn('flex items-center gap-1.5', className)}>
      ...
      {/* Status icon */}
      <Icon className={cn(sizeClass, config.color, status === 'pending' && 'animate-spin')} />
