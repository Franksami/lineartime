      ...
      gridCells.push(
        <div
          ...
          className={cn(
            ...
            hasHighCapacity && 'ring-1 ring-green-400 /* TODO: Use semantic token */ /* TODO: Use semantic token *//50',
            hasLowCapacity && 'ring-1 ring-yellow-400 /* TODO: Use semantic token */ /* TODO: Use semantic token *//50',
            hasConflict && 'ring-2 ring-red-400 /* TODO: Use semantic token */ /* TODO: Use semantic token */'
          )}
          style={{
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                {systemIntegrationState.aiSystemOnline && (
                  <div className="flex items-center gap-1 text-xs text-green-600 /* TODO: Use semantic token */ /* TODO: Use semantic token */">
                    <Zap className="w-3 h-3" />
                    <span>AI</span>
                  </div>
                )}
                {systemIntegrationState.providerSyncEnabled && (
                  <div className="flex items-center gap-1 text-xs text-blue-600 /* TODO: Use semantic token */ /* TODO: Use semantic token */">
                    <Globe className="w-3 h-3" />
                    <span>Sync</span>
                  </div>
                )}
                {systemIntegrationState.governanceActive && (
                  <div className="flex items-center gap-1 text-xs text-purple-600 /* TODO: Use semantic token */ /* TODO: Use semantic token */">
