      ...
      {process.env.NODE_ENV === 'development' && (
        <div className="absolute bottom-4 right-4 z-50 bg-card border border-border rounded-lg p-3 text-xs shadow-lg">
          ...
          <div className="space-y-1">
            ...
            <div>Success Rate: <span className="font-mono text-green-600 /* TODO: Use semantic token */ /* TODO: Use semantic token */">
              {dragMetrics.totalDrags > 0 
                ? Math.round((dragMetrics.successfulDrops / dragMetrics.totalDrags) * 100) 
                : 0}%
            </span></div>
            <div>Conflicts: <span className="font-mono text-yellow-600 /* TODO: Use semantic token */ /* TODO: Use semantic token */">{dragConflicts.length}</span></div>
