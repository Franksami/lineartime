...
const GestureInstructions = () => {
  const gestures = [
    ...
    },
    {
      ...
      color: 'bg-pink-500 /* TODO: Use semantic token */ /* TODO: Use semantic token */',
    },
  ];
    ...
    <Card className="mb-4">
      ...
      <CardContent className="space-y-3">
        <div className="grid grid-cols-3 gap-3 text-center">
          <div>
            <div className="text-lg font-bold text-blue-600 /* TODO: Use semantic token */ /* TODO: Use semantic token */">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-start gap-2">
                  <Accessibility className="w-4 h-4 text-green-600 /* TODO: Use semantic token */ /* TODO: Use semantic token */ mt-0.5" />
                  <div>
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-start gap-2">
                  <Settings className="w-4 h-4 text-blue-600 /* TODO: Use semantic token */ /* TODO: Use semantic token */ mt-0.5" />
                  <div>
