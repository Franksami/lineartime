...
export function OfflineSyncStatus({ className, showDetails = false }: OfflineSyncStatusProps) {
  ...
  const getSyncStatusIcon = () => {
    ...
    if (!isOnline) {
      return <WifiOff className="h-4 w-4 text-gray-500 /* TODO: Use semantic token */ /* TODO: Use semantic token */" />;
    }
    ...
    return <Clock className="h-4 w-4 text-yellow-500 /* TODO: Use semantic token */ /* TODO: Use semantic token */" />;
  };
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-base flex items-center gap-2">
                  <AlertCircle className="h-4 w-4 text-yellow-500 /* TODO: Use semantic token */ /* TODO: Use semantic token */" />
