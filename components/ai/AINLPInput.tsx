            ...
            {enableVoiceInput && 'webkitSpeechRecognition' in window && (
              <button
                ...
                className={cn('p-2 rounded-md transition-colors', 'hover:bg-muted', {
                  'bg-red-500 /* TODO: Use semantic token */ /* TODO: Use semantic token */ text-white': isListening,
        ...
        {parsedEvent && parsedEvent.confidence > 0.4 && (
          ...
          >
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 p-2 bg-green-100 /* TODO: Use semantic token */ /* TODO: Use semantic token */ text-green-600 /* TODO: Use semantic token */ /* TODO: Use semantic token */ dark:bg-green-900 /* TODO: Use semantic token */ /* TODO: Use semantic token *//30 dark:text-green-400 /* TODO: Use semantic token */ /* TODO: Use semantic token */ rounded-full">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="font-medium mb-2 flex items-center gap-2">
                  {parsedEvent.title}
                  <span className="px-2 py-1 text-xs bg-blue-100 /* TODO: Use semantic token */ /* TODO: Use semantic token */ text-blue-800 /* TODO: Use semantic token */ /* TODO: Use semantic token */ dark:bg-blue-900 /* TODO: Use semantic token */ /* TODO: Use semantic token *//30 dark:text-blue-400 /* TODO: Use semantic token */ /* TODO: Use semantic token */ rounded-full">
