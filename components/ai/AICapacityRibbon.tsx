...
export function AICapacityRibbon({
  ...
  const capacityIcon = {
    low: <CheckCircle className="w-3 h-3 text-green-500" />,
    medium: <Activity className="w-3 h-3 text-blue-500" />,
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-full">
        {/* Background Track */}
        <div className="absolute inset-0 bg-gray-200 dark:bg-gray-800 rounded-full opacity-30" />
