        ...
        <Card className="p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        className={cn(
                          ...
                          system.status === 'active'
                            ...
                            : system.status === 'processing'
                              ...
                              : 'bg-gray-400 /* TODO: Use semantic token */ /* TODO: Use semantic token */'
                        )}
                      />
            ...
            <div className="space-y-4">
              ...
              <div className="bg-black/90 text-green-400 /* TODO: Use semantic token */ /* TODO: Use semantic token */ rounded-lg p-4 font-mono text-xs overflow-x-auto">
                <pre>{`
