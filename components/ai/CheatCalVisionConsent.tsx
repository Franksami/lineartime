                  ...
                  <AnimatePresence>
                    {showArchitecture && (
                      <motion.div
                        ...
                        className="bg-black text-green-400 rounded-lg p-4 font-mono text-xs overflow-x-auto"
                      >
              ...
              {currentStep === 'complete' && (
                ...
                >
                  ...
                  <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-purple-700 dark:text-purple-300 space-y-1 text-left max-w-md mx-auto">
