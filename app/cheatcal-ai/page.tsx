        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card className="text-center">
                <CardContent className="p-6">
                  ...
                  <div className="text-xs text-purple-600 mt-1">Active today</div>
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="p-6">
                  ...
                  <div className="text-xs text-pink-600 mt-1">Multi-modal fusion</div>
                </CardContent>
              </Card>
            </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="bg-black text-green-400 rounded-lg p-4 font-mono text-xs overflow-x-auto">
                  <pre>{`
                    ...
                    {systemStatus.vision.active ? (
                      <div className="space-y-4">
                        <div className="bg-muted/50 rounded-lg p-4 text-center">
                          <Eye className="w-12 h-12 mx-auto mb-2 text-blue-500" />
