    ...
    const result = streamText({
      ...
      tools: {
        ...
        suggestSchedule: tool({
          description:
            'Legacy: Suggest optimal time slots for a new event (use suggestTimes instead)',
        ...
        listOpenSlots: tool({
          ...
          execute: async ({ date, minDuration }) => {
            ...
            const slots = finder.findAvailableSlots(dayStart, dayEnd, minDuration, {
        ...
        summarizePeriod: tool({
          ...
          execute: async ({ startDate, endDate }) => {
            ...
            return {
              ...
              busiest:
                periodEvents.length > 20
                  ? 'Very busy period'
                  : periodEvents.length > 10
                    ? 'Moderately busy'
                    : 'Light schedule',
            };
          },
