...
const SAMPLE_EMAIL_THREADS: EmailThread[] = [
  {
    ...
    preview: 'Hi there! I wanted to schedule our AI integration planning meeting. How about Tuesday at 3pm? We should cover...',
...
Dan`,
  ...
  },
  {
    ...
    preview: 'The Command Workspace prototype looks great! I have some feedback on the three-pane layout...',
...
function useMailboxView() {
  ...
  const [activeThreadId, setActiveThreadId] = useState<string | null>(SAMPLE_EMAIL_THREADS[0]?.id || null)
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Button variant="outline" size="sm">
                <Star className={cn(
                  'h-4 w-4',
                  thread.isStarred && 'fill-primary text-primary'
                )} />
              </Button>
